...
public class Singelton {
	...
	public void fun() {
		System.out.println("fun  " + singleInstance.toString());
		System.out.println("fun  " + singleInstance.hashCode());
		System.out.println("Deepak");
	}

	public void foo() {
		System.out.println("foo  " + singleInstance.toString());
		System.out.println("foo  " + singleInstance.hashCode());
