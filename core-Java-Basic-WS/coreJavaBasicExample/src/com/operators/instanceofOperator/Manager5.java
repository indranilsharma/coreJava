...
// You cannot use a String representing the name of the class as the right
// operand.
public class Manager5 {
	public static void main(String[] argv) {
		...
		/*
		 * if(myObject instanceof "MyClass"){ System.out.println(
		 * "myobject is an instance of MyAnotherClass"); }
		 */
	}
