...
public class Maanger2 {
	...
	public static void main(String args[]) {
		...
		System.out.println(false && secondPart(true)); // false -- secondPart not reachable
		System.out.println(true && secondPart(true)); // false secondPart  reachable
	
		System.out.println(true | secondPart(true)); // true
		System.out.println(true || secondPart(true));// true -- secondPart not reachable
		System.out.println(false || secondPart(true));// true
	}
}
